...
<head>
    ...
    <title>Inicio de Sesión: Josué Milton Rauda Ramírez</title>
    <link rel="stylesheet" href="css/bootstrap.css">
    <link href="fonts/fontawesome/css/all.css">
...
<body>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-5 ml-4 mr-4 justify-content-center align-self-center">
            <h1>Diseñando Estrategias para la Recuperación y Migración de Base de Datos (RBK01)</h1>
            <form id="frm_iniciar_sesion" action="core/process.php" name="frm_iniciar_sesion" method="POST">
                <div class="form-group">
                    <label for="txt_user">Usuario: </label>
                    <input type="text" name="txt_user" id="txt_user" class="form-control" aria-describedby="txt_userHelp" maxlength="10" required>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="txt_pass" id="txt_pass" class="form-control" aria-describedby="txt_passHelp" maxlength="10" required>
